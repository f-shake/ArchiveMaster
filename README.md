...
| 文件筛选操作 | 对筛选后的文件进行复制、移动、删除操作 | 需要对某个目录中的一部分文件提取（复制、移动）到另一个位置，以及按规则删除文件或其他操作 | `FileFilterOperation` | |
...
| 重建   | 从文件归档包重建目录结构，或验证文件完整性 | `Rebuild` | [光盘归档工具](https://github.com/autodotua/DiscArchivingTool) |
| 包信息和验证 | 查看备份介质中文件包的信息，验证文件完整性 | `Verify` | [光盘归档工具](https://github.com/autodotua/DiscArchivingTool) |
...
下一步计划：增加`FileWatcher`备份、删除日志、清理物理备份文件
