...
| 批量重命名                                          | 重复文件清理                                            | 根据时间段归档                                              |
| --------------------------------------------------- | ------------------------------------------------------- | ----------------------------------------------------------- |
| ![4.批量重命名](imgs/文件目录工具/4.批量重命名.png) | ![5.重复文件清理](imgs/文件目录工具/5.重复文件清理.png) | ![6.根据时间段归档](imgs/文件目录工具/6.根据时间段归档.png) |
...
| 修复照片修改时间                                            | 创建照片集合副本                                            | 照片地理信息写入                                            | 照片位置分类                                        |
| ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | --------------------------------------------------- |
| ![1.修复照片修改时间](imgs/照片工具/1.修复照片修改时间.png) | ![2.创建照片集合副本](imgs/照片工具/2.创建照片集合副本.png) | ![3.照片地理信息写入](imgs/照片工具/3.照片地理信息写入.png) | ![4.照片位置分类](imgs/照片工具/4.照片位置分类.png) |
